        ...
        <Flex position='relative' mb='40px'>
            <Flex
                    ...
                    <Flex
                        ...
                        <Flex
                            ...
                            <Text color={textColor} fontWeight='medium'>
                                ...
                                <Link to="/admin/signup" style={{ color: '#4FD1C5', fontWeight: '600' }}>
                                    Sign Up
                                </Link>
                            </Text>
                        </Flex>
                ...
                <Box
                    ...
                    right='0px'>
                    <Box
                        bgImage={'https://github.com/Tuyenleuit212/purity-ui-dashboard/blob/main/src/assets/img/signInImage.png?raw=true'}
                        w='100%'
                        h='100%'
                        bgSize='cover'
                        bgPosition='50%'
